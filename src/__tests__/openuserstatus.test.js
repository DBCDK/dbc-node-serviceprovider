...
describe('Test transform of OpenUserStatus response', () => {
	...
	it('Response transform 3 ordered items', function() {
		...
		assert.equal(JSON.stringify(userStatusTransform.responseTransform(response)), JSON.stringify({"result":{"orderedItems":{"count":"3","orders":[{"author":["Holm, Gretelise, f. 1946"],"title":["Møgkællinger"],"queue":["1"],"pickUpAgency":["DK-737600"],"pickUpExpiryDate":["2015-11-03T00:00:00+01:00"],"status":["Available for pickup"]},{"author":["Ellemose, Søren"],"title":["Tidsmaskinen"],"queue":["1"],"pickUpAgency":["DK-737600"],"pickUpExpiryDate":["2015-11-06T00:00:00+01:00"],"status":["Available for pickup"]},{"author":["Bidstrup, Lise"],"title":["Overlevernes by"],"queue":["1"],"pickUpAgency":["DK-737600"],"pickUpExpiryDate":["2015-11-06T00:00:00+01:00"],"status":["Available for pickup"]}]},"loanedItems":{"count":"0"}},"info":{"userId":["1111"]},"error":[]}), 'Ordered items');
	...
	it('Response transform 0 loaned items', function() {
		...
		assert.equal(JSON.stringify(userStatusTransform.responseTransform(response)), JSON.stringify({"result":{"orderedItems":{"count":"3","orders":[{"author":["Holm, Gretelise, f. 1946"],"title":["Møgkællinger"],"queue":["1"],"pickUpAgency":["DK-737600"],"pickUpExpiryDate":["2015-11-03T00:00:00+01:00"],"status":["Available for pickup"]},{"author":["Ellemose, Søren"],"title":["Tidsmaskinen"],"queue":["1"],"pickUpAgency":["DK-737600"],"pickUpExpiryDate":["2015-11-06T00:00:00+01:00"],"status":["Available for pickup"]},{"author":["Bidstrup, Lise"],"title":["Overlevernes by"],"queue":["1"],"pickUpAgency":["DK-737600"],"pickUpExpiryDate":["2015-11-06T00:00:00+01:00"],"status":["Available for pickup"]}]},"loanedItems":{"count":"0"}},"info":{"userId":["1111"]},"error":[]}), '0 loaned items');
    ...
    console.log(JSON.stringify(response, false, ' '));
		assert.equal(JSON.stringify(userStatusTransform.responseTransform(response)), JSON.stringify({"result":{"orderedItems":{"count":"0"},"loanedItems":{"count":"2","loans":[{"author":["Hesel, Lene Ewald"],"title":["Pokker ta\' den rådne kat"],"dueDate":["2015-11-24T00:00:00+01:00"]},{"author":["Davis, Jim"],"title":["Garfield på bølgen blå"],"dueDate":["2015-11-24T00:00:00+01:00"]}]}},"info":{"userId":["1231231231"]},"error":[]}), '2 loaned items');
